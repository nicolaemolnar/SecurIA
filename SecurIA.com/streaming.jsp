        ...
        <div class="align-content-center rounded-top d-grid" style="border: 1px solid;">
            ...
            <div class="d-flex row mb-3 justify-content-center">
                <div class="d-flex col justify-content-center">
                    <span class="h5 fw-bold mb-0 mt-1">Date: 00/00/0000</span>
                </div>
                <div class="d-flex col justify-content-center">
                    <span class="h5 fw-bold mb-0 mt-1">Time: 00:00:00</span>
                </div>
                <div class="d-flex col justify-content-center">
                    <span class="h5 fw-bold mb-0 mt-1">Label: Unknown</span>
                </div>
            </div>
        </div>
